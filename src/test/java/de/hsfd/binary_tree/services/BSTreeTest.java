...
class BSTreeTest {
    ...
    @Test
    public void testDeleteRootWithOneChildLeft() {
        BSTree tree = new BSTree();
        tree.insert(50);
        tree.insert(30);
        tree.delete(50);
    ...
    @Test
    public void testDeleteRootWithTwoChild() {
        BSTree tree = new BSTree();
        tree.insert(50);
        tree.insert(30);
        tree.insert(70);
    ...
    @Test
    public void testDeleteRootWithOneChildRight() {
        BSTree tree = new BSTree();
        tree.insert(50);
        tree.insert(70);
    ...
    public static boolean isBinarySearchTree(Node node) throws IllegalAccessException {
        return isBinarySearchTree(node, null, null);
    }

    private static boolean isBinarySearchTree(Node node, Comparable min, Comparable max) throws IllegalAccessException {
        if (node == null) {
            return true;
        }
